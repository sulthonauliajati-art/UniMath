...
export default function ClassDetailPage() {
  ...
  const handleRemoveStudent = async (studentId: string, studentName: string) => {
    if (!confirm(`Yakin ingin menghapus ${studentName} dari kelas ini?`)) return
            ...
            {students.map((student, index) => (
              ...
              >
                <GlassCard hover className="p-4">
                  <div className="flex items-center gap-4">
                    <Link href={`/teacher/students/${student.id}`} className="flex items-center gap-4 flex-1">
                    ...
                    <button
                      ...
                      className="p-2 text-text-secondary hover:text-uni-error transition-colors"
